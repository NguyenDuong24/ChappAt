...
const IconSelectionScreen = () => {
  ...
  // Optimized item rendering using React.memo
  ...
  // Get layout for FlatList to improve performance with large lists
    ...
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          extraData={selectedIcon}  // Ensures selected icon triggers re-render only when changed
        />
      )}
      <TouchableOpacity
