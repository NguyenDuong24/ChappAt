...
export const AppStateProvider = ( { children }) => {
    ...
    useEffect(() => {
        const subscription = RNAppState.addEventListener("change", nextAppState => {
            ...
            if (nextAppState === "active") {
                handleUserActive(user?.uid); // Cập nhật trạng thái người dùng khi ứng dụng active
            } else if((nextAppState === "background")) {
                handleUserBackground(user?.uid); // Cập nhật trạng thái người dùng khi ứng dụng background
            }
        });
    ...
    // Cập nhật trạng thái người dùng là offline
